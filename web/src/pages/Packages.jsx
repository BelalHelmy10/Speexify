    ...
    (async () => {
      ...
      try {
        const [indRes, corpRes] = await Promise.all([
          axios
            .get("http://localhost:5050/api/packages?audience=INDIVIDUAL")
            .catch(() => ({ data: [] })),
          axios
            .get("http://localhost:5050/api/packages?audience=CORPORATE")
            .catch(() => ({ data: [] })),
        ]);
        ...
        <div className="spx-pkg__container spx-pkg-cta__inner">
          ...
          {tab === AUD.INDIVIDUAL ? (
            <div className="spx-pkg-cta__actions">
              ...
              <a className="spx-pkg-btn spx-pkg-btn--ghost" href="/packages">
            ...
            <div className="spx-pkg-cta__actions">
              ...
              <a className="spx-pkg-btn spx-pkg-btn--ghost" href="/corporate">
                Learn more
              </a>
            </div>
          )}
      ...
      <div className="spx-pkg-card__actions">
        {isCorp ? (
          <>
            ...
            <a href="/corporate" className="spx-pkg-btn spx-pkg-btn--ghost">
              Learn more
            </a>
          </>
        ) : (
