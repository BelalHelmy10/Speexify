// src/components/Footer.jsx - PREMIUM EDITION
          ...
          <nav className="footer-nav">
            <div className="nav-col">
              ...
              <ul className="nav-col-list">
                <li>
                  <Link to="/individual-training" className="nav-col-link">
                ...
                <li>
                  <Link to="/corporate-training" className="nav-col-link">
                ...
                <li>
                  <Link to="/packages" className="nav-col-link">
                    <span>Packages</span>
                    <svg
                      className="link-arrow"
                      width="14"
            ...
            <div className="nav-col">
              ...
              <ul className="nav-col-list">
                <li>
                  <Link to="/about" className="nav-col-link">
                    <span>About</span>
                    <svg
                      className="link-arrow"
                      width="14"
                ...
                <li>
                  <Link to="/contact" className="nav-col-link">
                    <span>Contact</span>
                    <svg
                      className="link-arrow"
                      width="14"
                ...
                <li>
                  <Link to="/careers" className="nav-col-link">
                    <span>Careers</span>
                    <svg
                      className="link-arrow"
                      width="14"
